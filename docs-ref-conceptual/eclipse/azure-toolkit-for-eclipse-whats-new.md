...
ms.locfileid: "52338859"
---
# <a name="whats-new-in-the-azure-toolkit-for-eclipse"></a><span data-ttu-id="274a2-103">Novedades del kit de herramientas de Azure para Eclipse</span><span class="sxs-lookup"><span data-stu-id="274a2-103">What's new in the Azure Toolkit for Eclipse</span></span>

<span data-ttu-id="274a2-104">La siguiente página web contiene información sobre las diversas versiones y actualizaciones más recientes para el kit de herramientas de Azure para Eclipse.</span><span class="sxs-lookup"><span data-stu-id="274a2-104">The following web page contains information on the various releases and latest updates to the Azure Toolkit for Eclipse.</span></span>

<https://github.com/Microsoft/azure-tools-for-java/releases>

> [!NOTE] 
> <span data-ttu-id="274a2-105">También hay un Kit de herramientas de Azure para el IDE de IntelliJ.</span><span class="sxs-lookup"><span data-stu-id="274a2-105">There is also an Azure Toolkit for the IntelliJ IDE.</span></span> <span data-ttu-id="274a2-106">Para más información, consulte [Kit de herramientas de Azure para IntelliJ].</span><span class="sxs-lookup"><span data-stu-id="274a2-106">For more information, see [Azure Toolkit for IntelliJ].</span></span> 
> 
...
## <a name="next-steps"></a><span data-ttu-id="274a2-107">Pasos siguientes</span><span class="sxs-lookup"><span data-stu-id="274a2-107">Next steps</span></span>
