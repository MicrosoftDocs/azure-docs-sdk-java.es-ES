...
- [App Service en Linux](https://docs.microsoft.com/en-us/azure/app-service/containers/app-service-linux-intro)
...
- [CLI de Azure 2.0](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest)
...
- [Guía para desarrolladores de Java para App Service en Linux](https://docs.microsoft.com/en-us/azure/app-service/containers/app-service-linux-java)
- [Azure para desarrolladores de Java](https://docs.microsoft.com/en-us/java/azure/) Para más información acerca de Spring y Azure, vaya a la sección de Spring en el centro de documentación de Azure.
